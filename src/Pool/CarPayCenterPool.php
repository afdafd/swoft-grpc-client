...
/**
 * Class CarPayCenterPool
 * @package CarPayCenterPool
 *
 * @Bean("CarPayCenterPool")
 */
class CarPayCenterPool extends AbstractPool implements GrpcClientPoolInterface
{
    /**
     * @var string
     */
    protected $clientName = 'carPayCenter';
    ...
    {
        $config = $this->client->getCarPayCenter();
