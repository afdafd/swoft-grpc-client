...
/**
 * Class CarPublicCenterPool
 * @package Hzwz\Grpc\Client\Pool
 *
 * @Bean("CarPublicCenterPool")
 */
class CarPublicCenterPool extends AbstractPool implements GrpcClientPoolInterface
{
    /**
     * @var string
     */
    protected $clientName = 'carPublicCenter';
    ...
    {
        $config = $this->client->getCarPublicCenter();
