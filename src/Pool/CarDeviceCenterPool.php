...
/**
 * Class CarDeviceCenterPool
 * @package CarDeviceCenterPool
 *
 * @Bean("CarDeviceCenterPool")
 */
class CarDeviceCenterPool extends AbstractPool implements GrpcClientPoolInterface
{
    /**
     * @var string
     */
    protected $clientName = 'carDeviceCenter';
    ...
    {
        $config = $this->client->getCarDeviceCenter();
